export const BrainlyIcon = () => {
    return (
        <svg
            ...
            viewBox="0 0 48 48"
            style={{maxWidth:"40px",maxHeight:"40px", marginRight:"6px",stroke:"currentcolor"}}
        >
            <defs>
                <style>
                    {`.cls-1{fill:none;width:35;stroke-linecap:round;stroke-linejoin:round;stroke-width:2px}`}
                </style>
            </defs>
            <path
                className="cls-1"
